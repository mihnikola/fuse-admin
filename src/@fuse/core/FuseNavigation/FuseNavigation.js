...
import FuseNavVerticalCollapseRight from './vertical/types/FuseNavVerticalCollapseRight';
...
import FuseNavVerticalItemRight from './vertical/types/FuseNavVerticalItemRight';
...
registerComponent('vertical-collapse-right', FuseNavVerticalCollapseRight);
registerComponent('vertical-item', FuseNavVerticalItem);
registerComponent('vertical-item-right', FuseNavVerticalItemRight);
