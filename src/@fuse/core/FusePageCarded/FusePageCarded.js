...
const Root = styled('div')(({ theme, ...props }) => ({
  ...
  '& .FusePageCarded-header': {
    display: 'flex',
    flex: '0 0 auto',
    maxWidth: 'none !important', ///izmena je izvrsena
  },
  ...
  return (
    <>
      ...
      >
        ...
        <div className="flex flex-auto flex-col z-10 h-full shadow-1 relative overflow-hidden max-w-none"> {/*rounded-t-16* container*/}
          <div className="FusePageCarded-wrapper">
            ...
            > */}
            <div className='FusePageCarded-contentWrapper'>
              {props.content && (
