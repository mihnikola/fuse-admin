  ...
  return (
    <Paper className="flex flex-col flex-auto shadow rounded-2xl overflow-hidden p-20">
      ...
      <div className="text-center">
        <Typography className="text-lg font-medium text-amber-600 pb-20">{data.extra.name}</Typography>
        <Typography className="text-5xl sm:text-7xl font-semibold leading-none tracking-tight text-amber-500">
          {data.extra.count}
        </Typography>
